...
def save_monthly_highscores(output):
    ...
    file_name = 'Agriculture-Mago-' + today.strftime('%Y-%m') + '.json' # Cria o nome do arquivo a partir da data atual
...
for world in range(1, 6):
    ...
    data = {'server': world,
            'vocation': '3', # 0 = Todas, 1 = Cavaleiro, 2 = Bárbaro, 3 = Mago, 4 = Xamã, 5 = Arqueiro
