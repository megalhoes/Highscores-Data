...
def save_monthly_highscores(output):
    ...
    file_name = 'Explorador-Cavaleiro-' + today.strftime('%Y-%m') + '.json' # Cria o nome do arquivo a partir da data atual
...
for world in range(1, 6):
    ...
    data = {'server': world,
            ...
            'category': '21', # 0 = Experiência, 1 = Skill Ataque, 2 = Skill Escudo, 3 = Arena, 4 = Mineração, 5 = Forja
            'submit': 'Filtrar'}
