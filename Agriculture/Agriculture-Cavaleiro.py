...
def save_monthly_highscores(output):
    ...
    file_name = 'Agriculture-Cavaleiro-' + today.strftime('%Y-%m') + '.json' # Cria o nome do arquivo a partir da data atual
...
for world in range(1, 6):
    ...
    data = {'server': world,
            'vocation': '1', # 0 = Todas, 1 = Cavaleiro, 2 = Bárbaro, 3 = Mago, 4 = Xamã, 5 = Arqueiro
            'category': '17', # 0 = Experiência, 1 = Skill Ataque, 2 = Skill Escudo, 3 = Arena, 4 = Mineração, 5 = Forja
            'submit': 'Filtrar'}
